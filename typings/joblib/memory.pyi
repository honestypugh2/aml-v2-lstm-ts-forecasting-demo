...
class NotMemorizedResult:
    ...
    def __getstate__(self): # -> dict[str, bool | Any | None]:
        ...
...
class MemorizedFunc(Logger):
    ...
    def call(self, *args, **kwargs): # -> tuple[MemorizedResult, dict[str, Any | dict[str | Any, str] | float]] | tuple[Any, dict[str, Any | dict[str | Any, str] | float]]:
...
class AsyncMemorizedFunc(MemorizedFunc):
    ...
    async def call(self, *args, **kwargs): # -> Any | tuple[MemorizedResult, dict[str, Any | dict[str | Any, str] | float]] | tuple[Any, dict[str, Any | dict[str | Any, str] | float]]:
        ...
